...
#***********************************************
    ...
    def setupUi(self):
        ...
        self.read_flash_info_button.setDisabled(True)
    ...
    def ConnectSignalSlot(self):
        ...
        self.upgrade_button_golden.clicked.connect(self.golden_file_handler)
        self.read_flash_info_button.clicked.connect(self.read_flash_info_handler)
    ...
    def DisconnectSignalSlot(self):     
        ...
        self.upgrade_button_golden.clicked.disconnect(self.golden_file_handler)
        self.read_flash_info_button.clicked.disconnect(self.read_flash_info_handler)
    ...
    def closeEvent(self, event):
        ...
        if(self.connection_status == True):
            ...
            try:
                ...
                self.ut.close()
                del self.ut
    def read_flash_info_handler(self):
        if(self.connection_status == True):
    ...
    def ipaddr_connect_btn_handler(self):
        ...
        if status is False:
            ...
            if(self.connection_status == True):
                ...
                self.read_flash_info_button.setDisabled(False)
