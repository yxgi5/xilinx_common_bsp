...
class client(metaclass=Singleton):
    ...
    def client_start(self):
        ...
        self.tcp_socket.connect(self.target_addr)
    ...
    def client_concurrency(self):
        ...
        while not self.stop_running.is_set():
            ...
            try:
                self.recv_msg, self.recv_addr = self.tcp_socket.recvfrom(BUFSIZ)
                # self.recv_msg = self.tcp_socket.recv(BUFSIZ)
                # print(self.recv_msg)
            except Exception as ret:
    ...
    def send(self, send_msg):
        ...
        if self.link is False:
            ...
            try:
                self.tcp_socket.sendto(send_msg, self.target_addr)
            except Exception as ret:
                print('发送失败\n')
                raise Exception(ret)
    ...
    def close(self):
        ...
        try:
            # self.tcp_socket.shutdown(SHUT_RD)
